...
public enum PascalErrorCode {
  ...
  INVALID_VAR_PARAM("Invalid VAR param"),
  ...
  NOT_CONSTANT_IDENTIFIER("Not constant identifier"),
  NOT_RECORD_VARIABLE("Not record variable"),
  NOT_TYPE_IDENTIFIER("Not a type identifier"),
  RANGE_INTEGER("Integer literal out of range"),
  RANGE_REAL("Real literal out range"),
  STACK_OVERFLOW("Stack overflow"),
  TOO_MANY_LEVEL("Nesting level too deep"),
